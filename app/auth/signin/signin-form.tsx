  ...
  if (!created) {
      ...
      <div className="mx-auto flex flex-col justify-center space-y-4 w-[350px]">
        ...
        <Form {...form}>
          ...
          >
            ...
            ></FormField>
            <Separator
              className={`my-2 ${form.formState.errors.name && "mt-0"}`}
            ></Separator>
            <FormField
              control={form.control}
              name="email"
            ...
            ></FormField>
            <Separator
              className={`my-2 ${form.formState.errors.confirmEmail && "mt-0"}`}
            ></Separator>
            <FormField
              control={form.control}
              name="password"
    ...
    return (
      <div className="flex flex-col items-center gap-8">
        <h3 className="font-title text-5xl w-full text-center">
          Sucessfully created an account.
        </h3>
        <Link href="/auth/login">
          <Button variant="outline">Go to log in page!</Button>
        </Link>
      </div>
    );
  }
