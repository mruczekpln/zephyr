...
export default function Account() {
		...
		content = (
			<>
				<Avatar className='w-32 h-32 outline outline-offset-8 outline-black/50 flex items-center justify-center'>
					{user.image ? <Image src={user.image || 'o'} alt='' fill></Image> : <UserCircle2 size='full'></UserCircle2>}
				</Avatar>
	...
	return (
		<div className='flex gap-8'>
			<div className='flex flex-col items-center gap-16 h-full w-full'>{content}</div>
		</div>
	)
}
